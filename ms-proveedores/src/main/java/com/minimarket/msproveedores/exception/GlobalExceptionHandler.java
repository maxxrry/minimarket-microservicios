...
import com.minimarket.msproveedores.dto.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> manejarProveedorDuplicado(
            ProveedorDuplicadoException ex,
            HttpServletRequest request) {

        log.warn("Proveedor duplicado: {}", ex.getMessage());
