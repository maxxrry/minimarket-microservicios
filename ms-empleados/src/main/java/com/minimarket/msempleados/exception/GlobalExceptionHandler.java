...
import com.minimarket.msempleados.dto.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleEmpleadoDuplicado(
            EmpleadoDuplicadoException ex, HttpServletRequest request) {
        log.warn("Empleado duplicado: {}", ex.getMessage());
        ErrorResponseDTO error = new ErrorResponseDTO(
                LocalDateTime.now(),
