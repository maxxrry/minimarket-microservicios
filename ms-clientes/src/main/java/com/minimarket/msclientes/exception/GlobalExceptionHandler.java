...
import com.minimarket.msclientes.dto.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleClienteDuplicado(
            ClienteDuplicadoException ex, HttpServletRequest request) {
